...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 24, 2025 at 08:06 AM
...
CREATE TABLE `payments` (
  ...
  `method` enum('transfer','credit_card','qris','cash') NOT NULL,
...
(1, 'Merisa', 'merisarahmadani226@gmail.com', '06be54d1967aa5e6f466fb796247c879', '085707725170', 'admin', '2025-07-24 05:57:58', '2025-07-24 05:57:58');
...
ALTER TABLE `studios`
  ...
  ADD KEY `idx_studio_status` (`status`);
